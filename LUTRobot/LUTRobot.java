...
public class LUTRobot extends AdvancedRobot implements LUTInterface {
		...
		public static double epsilon = 0.2; // the epsilon in epsilon greedy 
...
//				newAction = lutTable.selectAction(newState[0],newState[1],newState[2],newState[3],newState[4],0);  	// Pick the action according to improve the Q table
//				reward = 0;
//				reward = rewardHitByBullet + rewardHitRobot + rewardHitWall + rewardBulletHit;
//		
...
//			
//				state = newState;
//				action = lutTable.selectAction(newState[0],newState[1],newState[2],newState[3],newState[4],epsilon);  // Pick the action to perform
//				
//			}
//		}
